    ...
    for index, var in enumerate(vars):
        ...
        for (name, var2), vals in values.items():
            if var==var2 and len(vals)>0:
                fig.add_trace(Scatter(x=list(range(0,length,ceil(length/len(vals)))),y=vals, name=name))
...
if __name__ == "__main__":
    ...
    '''plot_experiment_4(expname="2 agents",names=["exp_4_a_com_easy_thomp", "exp_4_b_com_easy_thomp", "exp_4_c_com_easy_thomp", "exp_4_d_com_easy_thomp"],baselines=[0.25,0.25,None],dir="exp4",real_names=seed_names)
    plot_experiment_4(expname="oR4C",names=["exp_5_a_com_easy_thomp", "exp_5_b_com_easy_thomp", "exp_5_c_com_easy_thomp", "exp_5_d_com_easy_thomp"],baselines=[1/3,0.2,None],dir="exp5",real_names=seed_names)
    plot_experiment_4(expname="env=easy",names=["exp_6_a_com_r_easy_thomp", "exp_6_b_no_com_r_easy_thomp", "exp_6_c_com_r_3c_easy_thomp", "exp_6_d_no_com_r_3c_easy_thomp", "exp_6_e_com_r_3v_easy_thomp","exp_6_f_no_com_r_3v_easy_thomp"],baselines=[None,0.25,None],dir="exp6",
                      real_names=["Com., 2 ag.","No com., 2 ag.","Com., 3 ag.","No com., 3 ag.","Com., 3 ag.,<br>R4C","No com., 3 ag.,<br>R4C"]),
    plot_experiment_4(expname="env=medium",names=["exp_8_a_com_3c_middle", "exp_8_b_com_3c_middle", "exp_8_c_com_3v_middle","exp_8_d_com_3v_middle" ],y_ranges=[[-1.5,1],[0,1],[-5,-1]],baselines=[None,0.05,None],dir="exp8",real_names=["coop i)", "coop ii)", "R4C i)", "R4C ii)"]),
    plot_experiment_4(expname="no-com",names=["exp_7_a_no_com_r_middle", "exp_7_b_no_com_r_harder", "exp_7_c_no_com_r_hard"],y_ranges=[[-1.5,1],[0,1],[-5,-1]],baselines=[None,None,None],dir="exp7",
                      real_names=["medium", "hard", "very hard"])
    plot_experiment_4(expname="Social Reward Weights",names=["exp_9_a_com_easy_thomp", "exp_9_b_com_easy_thomp", "exp_9_c_com_easy_thomp","exp_9_d_com_easy_thomp","exp_9_e_com_easy_thomp","exp_9_f_com_easy_thomp" ],y_ranges=[[-1.5,1],[0,1],[-5,-1]],baselines=[0.25,0.25,None],dir="exp9",real_names=["w=0.01","w=0.05","w=0.1","w=1","w=10","w=50"]),
    '''
    plot_experiment_4(expname="Test returns / env=choice (com)",names=["sac_choice"],y_ranges=[[0,1]],baselines=[0.25],dir="sac",real_names=["SAC com."], vars=[TEST_RETURNS],fileapp="_1")
    plot_experiment_4(expname="Test returns / env=random (no. com)",names=["sac_exp_6_b_no_com_r_easy_thomp"],y_ranges=[[-1.5,1.2]],baselines=[2/3],dir="sac",real_names=["SAC no com."], vars=[TEST_RETURNS],fileapp="_2")
